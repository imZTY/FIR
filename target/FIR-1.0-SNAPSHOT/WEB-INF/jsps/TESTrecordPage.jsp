...
<div class="box">
    <c:forEach var="record" items="${firGameRecordList}">
        <div class="history" id="${record.finishTime}">
            ...
            <div class="can">
                <canvas width="210" height="210" class="gobang" id="${record.finishTime}${record.result}">
                </canvas>
            </div>
                <script type="text/javascript">finalll("${record.finishTime}${record.result}","${record.recordString}")</script>
